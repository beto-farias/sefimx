...
/**
 * RelClientesDocumentosSearch represents the model behind the search form of `common\models\RelClientesDocumentos`.
 */
class RelClientesDocumentosSearch extends RelClientesDocumentos
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_cliente_documento', 'id_cliente', 'id_tipo_documentos', 'b_habilitado'], 'integer'],
    ...
    {
        $query = RelClientesDocumentos::find();
        ...
        $query->andFilterWhere([
            'id_cliente_documento' => $this->id_cliente_documento,

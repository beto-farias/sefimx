...
/**
 * CatTiposRelacionesClientesSearch represents the model behind the search form of `common\models\CatTiposRelacionesClientes`.
 */
class CatTiposRelacionesClientesSearch extends CatTiposRelacionesClientes
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_tipo_relacion', 'b_habilitado'], 'integer'],
    ...
    {
        $query = CatTiposRelacionesClientes::find();

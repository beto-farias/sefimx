...
/**
 * CatTiposProductosSearch represents the model behind the search form of `common\models\CatTiposProductos`.
 */
class CatTiposProductosSearch extends CatTiposProductos
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_tipo_producto', 'b_habilitado'], 'integer'],

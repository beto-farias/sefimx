...
/**
 * CatTiposDocumentosSearch represents the model behind the search form of `common\models\CatTiposDocumentos`.
 */
class CatTiposDocumentosSearch extends CatTiposDocumentos
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_tipo_documentos', 'b_documento_cliente', 'b_habilitado'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'b_documento_cliente' => $this->b_documento_cliente,
